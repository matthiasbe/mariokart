#include "./../../include/texturing/TexturedRoadRenderable.hpp"
...
TexturedRoadRenderable::~TexturedRoadRenderable()
{
...
TexturedRoadRenderable::TexturedRoadRenderable(ShaderProgramPtr shaderProgram, const std::string& filename)
...
void TexturedRoadRenderable::do_draw()
{
    //Location
...
void TexturedRoadRenderable::do_animate(float time)
{

}

void TexturedRoadRenderable::do_keyPressedEvent( sf::Event& e )
{
